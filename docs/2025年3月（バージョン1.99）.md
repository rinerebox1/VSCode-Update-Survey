...
![Image 13: Screenshot showing the repository status bar item for workspaces that contain more than one repository.](https://code.visualstudio.com/assets/updates/1_99/scm-repository-picker.png)
